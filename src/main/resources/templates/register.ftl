...
<form id="register-form" data-toggle="validator">
	...
	<div class="form-group has-feedback">
		...
		<input type="text" id="name" name="name" class="form-control" placeholder="Name" autocomplete="off" pattern="[a-zA-Z]([-_]?[a-zA-Z0-9]+)*" data-remote="<@url "register/validate/name"/>" data-remote-error="Name is already in use" required>
		<@form_feedback_icon/>
		<@form_helper_errors/>
	</div>
	<div class="form-group has-feedback">
